...
> Finding 字段契约见 `references/common.md` §3；独立评审/上下文隔离规则见 `references/common.md` §4；关系分类 7 类见 `protocols/consolidation-protocol.md` §6。
...
| ------------------- | -------------- | ----------- | ----------- | ------------------- |
| product-reviewer | PRODUCT_REVIEW | <REVIEW_ID> | <PATH>      | AVAILABLE / MISSING |
| system-critic    | SYSTEM_REVIEW  | <REVIEW_ID> | <PATH>      | AVAILABLE / MISSING |
| test-designer    | TEST_REVIEW    | <REVIEW_ID> | <PATH>      | AVAILABLE / MISSING |
